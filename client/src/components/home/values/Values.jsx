    ...
    return(
        <div className={styles.valueSection}>
                ...
                <div className={styles.valueCard}>
                    {/* Placeholder for Icon 1: Networking/Business (e.g., handshake or briefcase icon) */}
                ...
                <div className={styles.valueCard}>
                    {/* Placeholder for Icon 2: Social/Hobby (e.g., coffee cup or lightbulb icon) */}
                    <div className={styles.valueIcon}>☕</div> 
                ...
                <div className={styles.valueCard}>
                    {/* Placeholder for Icon 3: Organization/Simplicity (e.g., calendar or rocket icon) */}
                    <div className={styles.valueIcon}>🚀</div> 
